...
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].start(); // window.addEventListener("DOMContentLoaded", (event) => {
//     const selectInputs = document.querySelectorAll(".categorySelect");
//     selectInputs.forEach((sInput) => {
//         sInput.addEventListener("change", (e) => {
//             console.log(e.target);
//         });
//     });
//     const table = new DataTable("#resultsTable", {
//         searchable: false,
//         fixedHeight: false,
//         paging: false,
//     });
...
//         const rows = tableRows.dt.data;
//         rows.map((row) => {
//             console.log(row);
//             const selection = row.querySelector("select.categorySelect");
